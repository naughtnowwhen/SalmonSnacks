...
var pike1 = {
    ...
    randomCustomersPerHour: function(){
      console.log('does randomCustomersPerHour fire?');
...
//declared totalCookie first so that I can call it in figureCookiesPerHourAndTotal
    totalCookie: function(){
      console.log('does totalCookie fire?');
      let cookiePlusser = 0;  
      ...
      figureCookiesPerHourAndTotal : function(){
        console.log('does figureCookiesPerHourAndTotal fire');
    ...
    this.cookiesPerHourArrAndTotal.push(this.totalCookie());  
      ...
      console.log('does hourFigurer fire?')  ;
      let am = 'am';
      let pm = 'pm';
